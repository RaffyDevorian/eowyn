            ...
            <div class="kecil">
                <div style="display:flex;">
                    ...
                    <div class="kanan2" style="width:50%;">
                        <div  class="logincw2">
                        <h1 class="welcome-login">Welcome To Eowyn !</h1>
                        <h1 class="welcome-login2">Login Below:</h1>
                        <input type="text" placeholder="Email address" class="logininput" />
                        <input type="text" placeholder="Password" class="logininput" />
                        <a link href="#/"><button class="btn btn-wide loginbtn">Sign In</button></a>
                        <div style="display:flex;">
                        <div style="width:30%">
                        <h1 class="logintxt">Don't have an account? </h1>
                        </div>
                        <div style="width:35%">
                        <a link href="#/register" class="link link-hover logintxt" style="color: #005dff;">Create One now</a>
                        </div>
                        </div>
                        </div>
                    </div>
